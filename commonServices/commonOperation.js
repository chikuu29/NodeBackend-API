...
// Generate tokens
const generateTokens = (payload, secretKey, accessExpirationDelta, refreshExpirationDelta) => {
    const access_token_exp = Math.floor(Date.now() / 1000) + accessExpirationDelta;
    const refresh_token_exp = Math.floor(Date.now() / 1000) + refreshExpirationDelta;
